...
public class ClienteDaoImpl implements ClienteDao {
    ...
    private static final String INSERT_QUERY = "INSERT INTO cliente (identificacion, nombre, genero, calificacionPrendasMasculinas, calificacionPrendasFemeninas, calificacionPrendasUnisex) VALUES (?, ?, ?, ?, ?, ?)";
    private static final String SELECT_ALL_QUERY = "SELECT * FROM cliente ORDER BY id";
    private static final String UPDATE_QUERY = "UPDATE cliente SET identificacion=?, nombre=?, genero=?, calificacionPrendasMasculinas=?, calificacionPrendasFemeninas=?, calificacionPrendasUnisex=? WHERE id=?";
    ...
    public boolean registrarCliente(Cliente cliente) throws DAOException {
        try (Connection con = Conexion.conectar();
            ...
            pstmt.setDouble(4, cliente.getCalificacionPrendasMasculinas());
            pstmt.setDouble(5, cliente.getCalificacionPrendasFemeninas());
            pstmt.setDouble(6, cliente.getCalificacionPrendasUnisex());
            pstmt.executeUpdate();
            return true;
    ...
    private Cliente obtenerClienteDesdeResultSet(ResultSet rs) throws SQLException {
        ...
        double calificacionPrendasMasculinas = rs.getDouble("calificacionPrendasMasculinas");
        double calificacionPrendasFemeninas = rs.getDouble("calificacionPrendasFemeninas");
        double calificacionPrendasUnisex = rs.getDouble("calificacionPrendasUnisex");
        return new Cliente(id, identificacion, nombre, genero, calificacionPrendasMasculinas, calificacionPrendasFemeninas, calificacionPrendasUnisex);
    }
}
