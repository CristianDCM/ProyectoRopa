...
public class ClienteCRUD {
    ...
    private static void actualizarCliente() {
        ...
        if (cliente != null) {
            ...
            double calificacionPrendasMasculinas = leerCalificacion("Ingrese la calificacion de prendas Masculinas: ");
            double calificacionPrendasFemeninas = leerCalificacion("Ingrese la calificacion de prendas Femeninas: ");
            double calificacionPrendasUnisex = leerCalificacion("Ingrese la calificacion de prendas Unisex: ");

            cliente = new Cliente(id, identificacion, nombre, genero, calificacionPrendasMasculinas, calificacionPrendasFemeninas, calificacionPrendasUnisex);
    ...
    private static Cliente guardarCliente() {
        ...
        return new Cliente(identificacion, nombre, genero, calificacionPrendasMasculinas, calificacionPrendasFemeninas, calificacionPrendasUnisex);
    }
